...
htmlhelp_basename = 'daemonizerdoc'
...
latex_documents = [
    (master_doc, 'daemonizer.tex', 'daemonizer Documentation',
     [author], 'manual'),
]
...
man_pages = [
    (master_doc, 'daemonizer', 'daemonizer Documentation',
     [author], 1)
]
